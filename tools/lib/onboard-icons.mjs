export const ICONS = {
  ...
  compass: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><circle cx="12" cy="12" r="10"/><path d="m16.24 7.76-1.804 5.411a2 2 0 0 1-1.265 1.265L7.76 16.24l1.804-5.411a2 2 0 0 1 1.265-1.265z"/></svg>`,
  plug: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M12 22v-5"/><path d="M15 8V2"/><path d="M17 8a1 1 0 0 1 1 1v4a4 4 0 0 1-4 4h-4a4 4 0 0 1-4-4V9a1 1 0 0 1 1-1z"/><path d="M9 8V2"/></svg>`,
...
export const SECTION_META = {
  mcp_support: {
    eyebrow: "Connection",
    icon: "plug",
    lede: "MCP bridges between Ent, Cursor, and your site. Enable each integration below.",
  },
  ...
  security: {
    eyebrow: "Coming soon",
    icon: "shield",
    lede: "Ent will help schedule security audits and apply fixes from Cursor.",
  },
  discover: {
    eyebrow: "Discover",
    icon: "spark",
  ...
  setup: {
    eyebrow: "Start here",
    icon: "compass",
    lede: "Run these items in Cursor, then re-run onboard. You'll discover abilities as you go.",
  },
};
